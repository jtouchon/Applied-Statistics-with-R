...
```{r, echo=FALSE, fig.cap="Three beautiful treefrogs from Central America. Photos by Justin Touchon.", out.width = '100%'}
knitr::include_graphics("/Users/jutouchon/Desktop/Stats_Book/github_staging/pdf_versions/Treefrog_collage.png")
```
